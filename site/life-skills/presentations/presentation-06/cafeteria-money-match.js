  ...
  window.__CAFETERIA_CASHIER_BUILD = "v24-check-windowcap";
  console.info("[cafeteria-money-match] v24-check-windowcap loaded");
...
<svg viewBox="0 0 92 92" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="${label} play coin">
  ...
  if (!window.__CAF_CHECK_DELEGATE__) {
    ...
    window.addEventListener("click", delegate, true);
    window.addEventListener("pointerup", delegate, true);
  }

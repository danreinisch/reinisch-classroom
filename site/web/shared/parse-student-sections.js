(function (root, factory) {
  ...
  function parseStudentSections(text) {
    ...
    while (i < lines.length) {
      ...
      // Priority: "Assignment:" is checked before "Student:" in each header block.
      // If both appear (unlikely), the first "Assignment:" match wins.
      // This preserves backward compatibility with the legacy format.

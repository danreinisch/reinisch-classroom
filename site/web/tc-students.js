(async () => {
  ...
  async function renderExpandedDetail(studentCode) {
    ...
    // Tabs — these are static/trusted strings, safe for innerHTML
    ...
    // Tab content — trusted HTML from render functions
  ...
  async function handleSaveProgressData(goalId, e) {
    ...
    if (!dataDate) {
      await rcAlert('Validation', 'Please enter a date before saving');
      return;
    }
